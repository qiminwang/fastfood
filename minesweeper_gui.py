...
class Minesweeper:
    ...
    def __init__(self, master):
        ...
        # import images
        self.tile_plain = tkinter.PhotoImage(file = "images/original/tile_plain.png")
        self.tile_clicked = tkinter.PhotoImage(file = "images/original/tile_clicked.png")
        self.tile_mine = tkinter.PhotoImage(file = "images/original/tile_mine.png")
        self.tile_flag = tkinter.PhotoImage(file = "images/original/tile_flag.png")
        self.tile_wrong = tkinter.PhotoImage(file = "images/original/tile_wrong.png")
        self.tile_no = []
        for x in range(1, 9):
            self.tile_no.append(tkinter.PhotoImage(file = "images/original/tile_"+str(x)+".png"))
        ...
        for x in range(0, 100):
            ...
            self.buttons[x] = [ tkinter.Button(frame, image = gfx),
                                mine,
                                0,
                                x,
                                [y_coord, x_coord],
        ...
        self.label2 = tkinter.Label(frame, text = "Mines: "+str(self.mines))
